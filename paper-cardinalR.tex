...
Finally, we consider a cube that has a central spherical hole. This is generated using the \texttt{gen\_cubehole(n,\ p)} function. The cube is generated as per the uniformly distributed cube, but points inside sphere of radius \(0.5\) are removed, resulting in a hollow cube structure (Figure \ref{fig:cube-proj} c).
