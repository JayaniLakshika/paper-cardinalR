...
Sphere-shaped structures (Figure \ref{fig:sphere-proj}) are useful for evaluating how dimension reduction and clustering algorithms handle curved, symmetric manifolds in high-dimensional spaces. The package provides functions to generate a variety of spherical forms, including simple circles, uniform spheres, grid-based spheres, and complex arrangements like clustered spheres within a larger sphere. Table \ref{tab:sphere-tb-pdf} summarizes these functions.
