...
The \texttt{gen\_mobius(n,\ p)} function generates a dataset of \(n\) points that form a Mobius strip embedded in the first three dimensions of a \(p\text{-}D\). This classical non-orientable surface loops back on itself with a half-twist.
