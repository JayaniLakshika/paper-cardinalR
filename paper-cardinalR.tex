...
\midrule
\texttt{n} & numeric (vector) & Number of points in each cluster.\\
\texttt{k} & numeric & Number of clusters.\\
...
\midrule
\texttt{gen\_expbranches} & Exponential shaped branches.\\
\texttt{gen\_linearbranches} & Linear shaped branches.\\
\texttt{gen\_curvybranches} & Curvy shaped branches.\\
\texttt{gen\_orglinearbranches} & Linear shaped branches originated in one point.\\
\texttt{gen\_orgcurvybranches} & Curvy shaped branches originated in one point.\\
\bottomrule
\end{tabular}
\end{table}
...
Function & Explanation\\
\midrule
\texttt{gen\_gridcube} & Cube with specified grid points along each axes.\\
\texttt{gen\_unifcube} & Cube with uniform points.\\
\bottomrule
\end{tabular}
\end{table}
...
Function & Explanation\\
\midrule
\texttt{gen\_quadratic} & Quadratic pattern.\\
\texttt{gen\_cubic} & Cubic pattern.\\
\bottomrule
\end{tabular}
\end{table}
...
Function & Explanation\\
\midrule
\texttt{gen\_pyrrect} & Rectangular-base, with a sharp or blunted apex.\\
\texttt{gen\_pyrtri} & Triangular-base, with a sharp or blunted apex.\\
\texttt{gen\_pyrstar} & Star-shaped base, with a sharp or blunted apex.\\
\texttt{gen\_pyrfrac} & Pyramid with triangular pyramid-shaped holes.\\
\bottomrule
\end{tabular}
\end{table}
...
Function & Explanation\\
\midrule
\texttt{gen\_circle} & Circle.\\
\texttt{gen\_curvycycle} & Curvy cell cycle.\\
\texttt{gen\_unifsphere} & Uniform ball.\\
\texttt{gen\_hollowsphere} & Hollow sphere.\\
\texttt{gen\_gridedsphere} & Grided sphere.\\
\texttt{gen\_clusteredspheres} & Multiple small spheres within a big sphere.\\
\texttt{gen\_hemisphere} & Hemisphere.\\
\bottomrule
\end{tabular}
\end{table}
...
Function & Explanation\\
\midrule
\texttt{gen\_trefoil4d} & Trefoil in $4\text{-}D$.\\
\texttt{gen\_trefoil3d} & Trefoil in $3\text{-}D$.\\
\bottomrule
\end{tabular}
\end{table}
...
Function & Explanation\\
\midrule
\texttt{gen\_crescent} & Crescent pattern.\\
\texttt{gen\_curvycylinder} & Curvy cylinder.\\
\texttt{gen\_sphericalspiral} & Spherical spiral.\\
\texttt{gen\_helicalspiral} & Helical spiral.\\
\texttt{gen\_conicspiral} & Conic spiral.\\
\texttt{gen\_nonlinear} & Nonlinear hyperbola.\\
\bottomrule
\end{tabular}
\end{table}
