...
By providing these aspects, \texttt{cardinalR} provides researchers with a method to generate more explainable and challenging high-dimensional clustering synthetic datasets focused to the specific needs of evaluating algorithms.
