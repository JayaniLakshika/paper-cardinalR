...
\texttt{gen\_pyrrect} & \texttt{n, p} & Rectangular-base, with a sharp or blunted apex.\\
\texttt{gen\_pyrtri} & \texttt{n, p} & Triangular-base, with a sharp or blunted apex.\\
\addlinespace
\texttt{gen\_pyrstar} & \texttt{n, p} & Star-shaped base, with a sharp or blunted apex.\\
...
\texttt{gen\_gridedsphere} & \texttt{n, k, r, loc} & Grided sphere.\\
\texttt{gen\_clusteredspheres} & \texttt{n, w} & Multiple small spheres within a big sphere.\\
\texttt{gen\_hemisphere} & \texttt{n, steps} & Hemisphere.\\
\addlinespace
\texttt{gen\_swissroll} & \texttt{n, steps} & Swissroll structure.\\
\texttt{gen\_trefoil4d} & \texttt{n} & Trefoil in $4\text{-}D$.\\
\texttt{gen\_trefoil3d} & \texttt{n, h} & Trefoil in $3\text{-}D$.\\
\texttt{gen\_crescent} & \texttt{n, spins} & Crescent pattern.\\
\texttt{gen\_curvycylinder} & \texttt{n} & Curvy cylinder.\\
\addlinespace
\texttt{gen\_sphericalspiral} & \texttt{n, spins} & Spherical spiral.\\
\texttt{gen\_helicalspiral} & \texttt{n, hc, non\_fac} & Helical spiral.\\
\texttt{gen\_conicspiral} & \texttt{n} & Conic spiral.\\
\texttt{gen\_nonlinear} & \texttt{n} & Nonlinear hyperbola.\\
\bottomrule
\end{tabular}
\end{table}
