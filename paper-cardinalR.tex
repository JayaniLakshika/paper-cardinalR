...
\caption{\label{tab:main-tb-pdf}The main arguments for `gen_multicluster()`.}
\centering
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{4cm}>{\raggedright\arraybackslash}p{8cm}}
\toprule
...
\includegraphics[width=1\linewidth]{paper-cardinalR_files/figure-latex/unnamed-chunk-13-1}
