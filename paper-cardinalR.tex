...
\begin{figure}[H]
\includegraphics[width=1\linewidth]{paper-cardinalR_files/figure-latex/cone-proj-1} \caption{Three $2\text{-}D$ projections from the $4\text{-}D$ `cone` data.}\label{fig:cone-proj}
\end{figure}
