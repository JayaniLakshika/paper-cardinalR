...
\begin{figure}[!]
\includegraphics[width=1\linewidth]{paper-cardinalR_files/figure-latex/fig-trefoil-proj-1} \caption{Three $2\text{-}D$ projections from $4\text{-}D$, for the `trefoil4d` and `trefoil3d` data.}\label{fig:fig-trefoil-proj}
\end{figure}
