...
{\centering \includegraphics[width=0.7\linewidth,alt={Diagram showing the workflow for generating high-dimensional clustered data, from specifying input parameters to producing the final labeled dataset with optional noise dimensions.}]{figures/cardinalR_workflow} 
...
{\centering \includegraphics[width=0.8\linewidth,alt={Nine 2-D projections of four 4-D pyramid-like datasets: pyrrect, pyrtri, pyrstar, and pyrholes, showing their distinct geometries, branching, and hollow regions.}]{paper-cardinalR_files/figure-latex/pyr-proj-1} 
...
{\centering \includegraphics[width=0.8\linewidth,alt={Nine 2-D projections of three datasets: circle, curvycycle, and clusteredspheres, showing closed loops, twisted rings, and compact spherical clusters, illustrating projection effects on structure, density, and separation.}]{paper-cardinalR_files/figure-latex/sphere-proj-1} 
...
{\centering \includegraphics[width=0.8\linewidth,alt={Six 2-D projections of trefoil knot datasets, showing complex 4-D trefoil loops and simpler 3-D knot structures, illustrating curvature, twisting, and separation across dimensions.}]{paper-cardinalR_files/figure-latex/trefoil-proj-1} 
...
{\centering \includegraphics[width=0.7\linewidth,alt={Twelve 2-D projections of four 4-D datasets: curvycylinder, sphericalspiral, conicspiral, and nonlinear, showing cylindrical twists, spiral and conical helices, and warped 2-D surfaces, illustrating curvature, density, and continuity.}]{paper-cardinalR_files/figure-latex/triginometric-proj-1} 
