...
\begin{figure}[H]
\includegraphics[width=1\linewidth]{paper-cardinalR_files/figure-latex/branch-proj-1} \caption{Three $2\text{-}D$ projections from $4\text{-}D$, for the `orglinearbranches` (a1-a3) data.}\label{fig:branch-proj}
\end{figure}
