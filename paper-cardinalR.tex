...
\begin{figure}[H]
\includegraphics[width=1\linewidth]{figures/cardinalR} \caption{Workflow of.}\label{fig:workflow}
\end{figure}
...
\caption{\label{tab:summaryclust-tb-pdf}cardinalR branching data generation functions}
\centering
...
\toprule
Metric & wb.ratio & Dunn\_Index & Corrected\_Rand & VI\\
\midrule
