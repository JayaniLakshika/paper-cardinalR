...
\caption{\label{tab:branching-tb-html}cardinalR branching data generation functions}
\centering
\begin{tabular}[t]{l|l}
\hline
...
\caption{\label{tab:cube-tb-html}cardinalR cube data generation functions}
\centering
\begin{tabular}[t]{l|l}
\hline
Function & Explanation\\
...
\caption{\label{tab:polynomial-tb-html}cardinalR polynomial data generation functions}
\centering
\begin{tabular}[t]{l|l}
\hline
Function & Explanation\\
...
\caption{\label{tab:pyramid-tb-html}cardinalR pyramid data generation functions}
\centering
\begin{tabular}[t]{l|l}
\hline
Function & Explanation\\
...
\caption{\label{tab:sphere-tb-html}cardinalR sphere data generation functions}
\centering
\begin{tabular}[t]{l|l}
\hline
Function & Explanation\\
...
\caption{\label{tab:trigonometric-tb-html}cardinalR trigonometric data generation functions}
\centering
\begin{tabular}[t]{l|l}
\hline
Function & Explanation\\
