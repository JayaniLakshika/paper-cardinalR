...
\caption{Three $2\text{-}D$ projections from $4\text{-}D$, for the `curvycylinder` (a1-a3), `sphericalspiral` (b1-b3), `conicspiral` (c1-c3), and `nonlinear` (d1-d3) data. Each shows variations in curvature, density, and continuity. Various geometric forms captured by the trigonometric shape generators, illustrating how different non-linear geometric structures can challenge to test the robustness of algorithms.}\label{fig:triginometric-proj}
\end{figure}
