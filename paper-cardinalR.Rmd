...
```{r cone-proj, eval=knitr::is_latex_output(), fig.cap="Three $2\\text{-}D$ projections from the $4\\text{-}D$ `cone` data.", fig.pos="H"}
#| fig-width: 12
#| fig-height: 4
...
```{r sphere, eval=knitr::is_html_output(), fig.cap="`langevitour` output  of the `circle`, `curvycycle`, and `clusteredspheres` data in $4\\text{-}D$."}
...
```{r sphere-proj, eval=knitr::is_latex_output(), fig.cap="Three $2\\text{-}D$ projections from $4\\text{-}D$, for the `circle` (a1-a3), `curvycycle` (b1-b3), and, `clusteredspheres` (c1-c3).", fig.width=12, fig.height=12, out.width="100%", fig.align='center', fig.pos="H"}
