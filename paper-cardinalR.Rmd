...
Table `r knitr::asis_output(ifelse(knitr::is_html_output(), '\\@ref(tab:shape-tb-html)', '\\@ref(tab:shape-tb-pdf)'))` outlines these functions. The main arguments of the functions described in Table `r knitr::asis_output(ifelse(knitr::is_html_output(), '\\@ref(tab:arg-shape-tb-html)', '\\@ref(tab:arg-shape-tb-pdf)'))`.
