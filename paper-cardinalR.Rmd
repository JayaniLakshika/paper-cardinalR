...
```{r branch-proj, eval=knitr::is_latex_output(), fig.cap="Three $2\\text{-}D$ projections from the $4\\text{-}D$ data generated using \\texttt{gen\\_orgcurvybranches}. Each shows a different projection, illustrating how the linear branches appear from multiple viewing angles. These views highlight the dataset’s underlying branching structure and demonstrate how projections reveal patterns that are otherwise hidden in higher dimensions.", fig.width=12, fig.height=4, fig.pos="H", fig.alt="Three $2\\text{-}D$ projections of the $4\\text{-}D$ orglinearbranches dataset, showing different angles of the linear branches to illustrate the branching structure.", fig.pos="!ht"}
