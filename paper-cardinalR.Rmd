...
Table `r knitr::asis_output(ifelse(knitr::is_html_output(), '\\@ref(tab:branching-tb-html)', '\\@ref(tab:branching-tb-pdf)'))` outlines these functions. The main arguments of the functions described in Table `r knitr::asis_output(ifelse(knitr::is_html_output(), '\\@ref(tab:arg-branching-tb-html)', '\\@ref(tab:arg-branching-tb-pdf)'))`.
