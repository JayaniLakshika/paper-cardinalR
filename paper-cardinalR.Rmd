...
```{r, label = "fig-cubic-proj", fig.cap="Three $2\\text{-}D$ projections from $4\\text{-}D$, for the `quadratic` and `cubic` data."}
#| fig-width: 15
#| fig-height: 10
...
```{r, label = "fig-scurve-proj", fig.cap="Three $2\\text{-}D$ projections from $4\\text{-}D$, for the `scurve` and `scurvehole` data."}
#| fig-width: 15
#| fig-height: 10
