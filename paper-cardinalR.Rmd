...
```{r, label = "fig-cluster-stats", fig.width=10, fig.height=3, out.width="100%", layout="l-body", fig.cap="Comparison of clustering performance metrics (within–between ratio (wb.ratio), Dunn index, Corrected Rand index, and variation of information (VI) across $k$-means, hierarchical, and model-based clustering methods."}
...
```{r summaryclust-tb-html,  eval=FALSE}
summary_clust |> 
...
```{r summaryclust-tb-pdf,  eval=FALSE}
summary_clust |> 
