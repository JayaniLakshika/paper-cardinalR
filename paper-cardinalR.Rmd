...
```{r branch, eval=knitr::is_html_output(), fig.cap="`langevitour` output of the `orglinearbranches` data in $4\\text{-}D$. The tour views shows how the linear branches appear from multiple viewing angles."}
