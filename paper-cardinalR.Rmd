...
```{r branch, eval=knitr::is_html_output(), fig.cap="`langevitour` output  of the `orglinearbranches` data in $4\\text{-}D$."}
...
```{r branch-proj, eval=knitr::is_latex_output(), fig.cap="Three $2\\text{-}D$ projections from $4\\text{-}D$, for the `orglinearbranches` (a1-a3) data.", fig.width=12, fig.height=4}
