...
The source material for this paper, including the full datasets and figures, is available at [github.com/JayaniLakshika/paper-cardinalR](https://github.com/JayaniLakshika/paper-cardinalR). This article is created using \CRANpkg{knitr} [@yihui2015] and \CRANpkg{rmarkdown} [@yihui2018] in R with the `rjtools::rjournal_article` template. These `R` packages were used for this work: `tibble` [@kirill2023], `gtools` [@gregory2023], `dplyr` [@hadley2023], `stats` [@core2025], `tidyr` [@hadley2024], `readr`, `purrr` [@hadley2025], `mvtnorm` [@alan2009], `geozoo` [@barret2016], `MASS` [@venables2002], `scikit-learn` [@pedregosa2011], `Rtsnse`, `uwot`, `phateR`, `pacmap`, `trimap`, `reticulate`, `quollr`, `proxy`. 
