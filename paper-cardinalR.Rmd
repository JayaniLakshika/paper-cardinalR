...
High-dimensional generalizations are provided by `gen_orglinearbranches(n, p, k)` and `gen_orgcurvybranches(n, p, k)` (`r knitr::asis_output(if (knitr::is_html_output()) { "Figure \\@ref(fig:branch) d-e"} else { "Figure \\@ref(fig:branch-proj) d-e"})`). Each branch is embedded in a unique or repeated $2\text{-}D$ subspace of the $p\text{-}D$ space. Linear branches follow
